...
exports.AppointmentModule = AppointmentModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            Appointmentservice_1.AppointmentService,
            AppointmentdomainService_1.AppointmentDomainService,
            {
                provide: 'AppointmentRepository',
                useClass: AppointmentDomainRepository_1.AppointmentDomainRepository,
            }
        ],
    })
], AppointmentModule);
